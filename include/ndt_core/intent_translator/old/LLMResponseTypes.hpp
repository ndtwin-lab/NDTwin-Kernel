...
to_json(nlohmann::json& j, const InstallFlowEntryTask& task)
{
    ...
    if (task.actionType != "")
    {
        action.push_back({{"type", task.actionType}, {"port", task.actionOutPort}});
    }
...
{
    j = nlohmann::json{{"parameters", {{"device_name", task.deviceName}, {"match", task.match}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{{"parameters", {{"k", task.k}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{{"parameters", {{"src", task.srcDeviceName}, {"dst", task.dstDeviceName}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{{"parameters", {{"src", task.srcHostName}, {"dst", task.dstHostName}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{{"parameters", {{"host_id", task.host_id}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{{"parameters", {{"src", task.src}, {"dst", task.dst}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{{"parameters", {{"match", task.match}, {"new_path", task.newPath}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{{"parameters", {{"device_name", task.deviceName}, {"state", task.state}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{
        {"parameters", {{"device_name", task.deviceName}, {"nickname", task.nickname}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{{"parameters", {{"state", task.state}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{
        {"parameters", {{"device_name", task.deviceName}, {"backup_path", task.backupPath}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{
        {"parameters", {{"device_name", task.deviceName}, {"restore_path", task.restorePath}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{{"parameters", {{"host", task.host}, {"count", task.count}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{{"parameters", {{"host", task.host}}}};
    task_to_json(j, task);
}
...
to_json(nlohmann::json& j, const SetPortStatusTask& task)
{
    j = nlohmann::json{
        {"parameters",
         {{"device_name", task.deviceName}, {"port_id", task.portId}, {"status", task.status}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{
        {"parameters", {{"device_name", task.deviceName}, {"port_id", task.portId}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{
        {"parameters", {{"device_name", task.deviceName}, {"line_count", task.lineCount}}}};
    task_to_json(j, task);
}
...
{
    j = nlohmann::json{
        {"parameters", {{"device_name", task.deviceName}, {"firmware_path", task.firmwarePath}}}};
    task_to_json(j, task);
}
...
{
    task.deviceName = j.at("parameters").at("device_name").get<std::string>();
    task.firmwarePath = j.at("parameters").at("firmware_path").get<std::string>();
    task_from_json(j, task);
}
...
from_json(const nlohmann::json& j, MonitorRealTimeTrafficTask& task)
{
    task.deviceName = j.at("parameters").at("device_name").get<std::string>();
    task.portId = j.at("parameters").at("port_id").get<int>();
    task.durationSeconds = j.at("parameters").value("duration_seconds", 10);
    task_from_json(j, task);
}
...
{
    j = nlohmann::json{{"explanation", ans.explanation}, {"valid", ans.valid}};
    if (ans.valid)
    {
        j["tasks"] = ans.tasks;
    }
